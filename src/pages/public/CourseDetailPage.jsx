  ...
  return (
    <>
      ...
      <div style={{ minHeight: 340, position: 'relative', display: 'flex', alignItems: 'flex-end', overflow: 'hidden', background: 'linear-gradient(140deg,#0d3840 0%,#082830 100%)' }}>
        ...
        {course.cover_image_url && <div className="hero-sharp-img" style={{ position: 'absolute', top: 0, left: 0, right: 0, backgroundImage: `url(${course.cover_image_url})`, backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }} />}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {course.description && (
              <div style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 12, padding: '1.5rem 1.75rem' }}>
                ...
                <div className="rich-html" style={{ fontSize: '.9rem', color: 'var(--text-2)', lineHeight: 1.75, fontWeight: 300 }} dangerouslySetInnerHTML={{ __html: sanitizeHtml(course.description) }} />
              </div>
            )}
