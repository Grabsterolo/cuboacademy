...
const EventWizardPage = lazy(() => import('../../pages/dashboard/instructor/EventWizardPage'))
const EventAttendancePage = lazy(() => import('../../pages/dashboard/instructor/EventAttendancePage'))
