...
const TYPES = {
  ...
  maintenance: {
    label: 'Mantenimiento', color: '#96530A',
...
export default function InstructorAnnouncementsPage() {
  ...
  useEffect(() => {
    runQuery(
      ...
      'InstructorAnnouncementsPage: comunicados',
    ...
    <DashboardLayout>
      ...
      <div className="ann-i-pad" style={{ padding: '2.5rem 2.5rem 3rem' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(1.6rem,3vw,2.2rem)', fontWeight: 700, color: 'var(--carbon)', lineHeight: 1.15, margin: 0 }}>Comunicados</h1>
        </div>
              ...
              <div style={{ padding: '1.75rem 2rem 1.5rem', flexShrink: 0 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '.55rem', padding: '.6rem .85rem', background: 'var(--cream)', border: '1px solid var(--border)', borderRadius: 9, width: 'fit-content' }}>
                  ...
                  <span style={{ fontSize: '.78rem', color: 'var(--carbon)', fontFamily: 'var(--sans)', fontWeight: 500 }}>
                    {formatDateFull(readItem.created_at)}
                  </span>
                </div>
              </div>
